...
- [ ] Add desktop sidebar browser coverage: project sections, active thread,
      badges, and new-thread action.
- [ ] Add compact sidebar browser coverage: collapsed state, expansion, footer
      containment, route preservation.
- [ ] Add worktree sidebar browser coverage: worktree label/path rule and
      composer cwd.
- [x] Add sidebar usability spec mapping existing coverage and missing
      desktop/compact/worktree behavior tests.
- [ ] Add composer single-line to multi-line transition browser coverage.
- [ ] Add composer delete-back-to-single-line browser coverage.
- [ ] Add inline edit click-to-focus latency and height parity coverage.
- [ ] Add plan build-handoff browser coverage from the workbench action.
- [ ] Stop accepting repeated browser-test warning noise as normal; fix or
