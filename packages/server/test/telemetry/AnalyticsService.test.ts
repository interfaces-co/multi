...
import { getTelemetryIdentifier } from "../../src/telemetry/Identify.ts";
import { AnalyticsService } from "../../src/telemetry/AnalyticsService.service.ts";
import { AnalyticsServiceLayerLive } from "../../src/telemetry/AnalyticsService.ts";
    ...
    Effect.gen(function* () {
      ...
      const configLayer = ConfigProvider.layer(
        ConfigProvider.fromUnknown({
          MULTI_TELEMETRY_ENABLED: true,
          MULTI_POSTHOG_KEY: "phc_test_key",
          MULTI_POSTHOG_HOST: "",
          MULTI_TELEMETRY_FLUSH_BATCH_SIZE: 20,
        }),
      );
