...
import type { OrchestrationReadModel } from "@multi/contracts";

import { OrchestrationEngineService } from "../../src/orchestration/OrchestrationEngine.service.ts";
import { TerminalManager } from "../../src/terminal/Manager.service.ts";
import { ProjectSetupScriptRunner } from "../../src/project/ProjectSetupScriptRunner.service.ts";
import { ProjectSetupScriptRunnerLive } from "../../src/project/ProjectSetupScriptRunner.ts";
  ...
  it("opens the deterministic setup terminal with worktree env and writes the command", async () => {
    ...
    expect(open).toHaveBeenCalledWith({
      ...
      env: {
        ...
        MULTI_WORKTREE_PATH: "/repo/worktrees/a",
      },
    });
