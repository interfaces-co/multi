...
} from "./checkpointing/CheckpointDiffQuery.service.ts";
import { GitCore, type GitCoreShape } from "./git/GitCore.service.ts";
import { GitManager, type GitManagerShape } from "./git/GitManager.service.ts";
import { GitStatusBroadcasterLive } from "./git/GitStatusBroadcaster.ts";
import {
  GitStatusBroadcaster,
  type GitStatusBroadcasterShape,
} from "./git/GitStatusBroadcaster.service.ts";
...
} from "./provider/ProviderRegistry.service.ts";
import {
  ServerLifecycleEvents,
  type ServerLifecycleEventsShape,
} from "./server-lifecycle-events.ts";
import { ServerRuntimeStartup, type ServerRuntimeStartupShape } from "./server-runtime-startup.ts";
import { ServerSettingsService, type ServerSettingsShape } from "./server-settings.ts";
import { TerminalManager, type TerminalManagerShape } from "./terminal/Manager.service.ts";
import {
  BrowserTraceCollector,
  type BrowserTraceCollectorShape,
} from "./observability/BrowserTraceCollector.service.ts";
import { ProjectFaviconResolverLive } from "./project/ProjectFaviconResolver.ts";
import {
  ProjectSetupScriptRunner,
  type ProjectSetupScriptRunnerShape,
} from "./project/ProjectSetupScriptRunner.service.ts";
import {
  RepositoryIdentityResolver,
  type RepositoryIdentityResolverShape,
} from "./project/RepositoryIdentityResolver.service.ts";
import {
  ServerEnvironment,
