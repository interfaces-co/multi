...
import { OrchestrationCommandReceiptRepository } from "../persistence/OrchestrationCommandReceipts.service.ts";
import {
...
} from "./OrchestrationEngine.service.ts";
...
const makeOrchestrationEngine = Effect.gen(function* () {
  ...
  readModel = yield* threadProjection.getSnapshot();
