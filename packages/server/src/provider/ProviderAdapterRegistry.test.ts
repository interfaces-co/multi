...
import type { ClaudeAdapterShape } from "./ClaudeAdapter.service.ts";
import { CodexAdapter } from "./CodexAdapter.service.ts";
import type { CodexAdapterShape } from "./CodexAdapter.service.ts";
import { CursorAdapter } from "./CursorAdapter.service.ts";
import type { CursorAdapterShape } from "./CursorAdapter.service.ts";
import { OpenCodeAdapter } from "./OpenCodeAdapter.service.ts";
import type { OpenCodeAdapterShape } from "./OpenCodeAdapter.service.ts";
