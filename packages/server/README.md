...
- Provider SDK/process callback files (`ClaudeAdapter`, `ClaudeProvider`, `CursorProvider`, `codex-app-server`, `codex-app-server-manager`): JSON/platform/SDK callback boundaries.
