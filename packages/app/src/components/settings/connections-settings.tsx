...
import { formatElapsedDurationLabel, formatExpiresInLabel } from "../../timestamp-format";
import {
...
import { QRCodeSvg } from "@multi/ui/qr-code";
...
import { setPairingTokenOnUrl } from "../../pairing-url";
import {
      ...
      <SettingsItemRowInner>
        <div className="min-w-0 flex-1 space-y-1">
          ...
          {shareablePairingUrl === null ? (
            <p className="text-detail text-muted-foreground/70">
