...
export const COMPOSER_INLINE_SKILL_CHIP_CLASS_NAME =
  "inline-flex max-w-full select-none items-center gap-1 rounded-sm border border-[var(--multi-composer-object-border)] bg-[var(--multi-composer-object-bg)] px-1.5 py-px font-multi text-[12px]/[16px] font-medium text-[var(--multi-composer-object-fg)] align-middle";
