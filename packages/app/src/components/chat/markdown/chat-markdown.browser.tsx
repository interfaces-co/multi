...
describe("chat-markdown", () => {
  ...
  it("disambiguates duplicate file basenames inline", async () => {
    const firstPath =
      "/Users/yashsingh/p/multi/packages/app/src/components/chat/messages-timeline.tsx";
    const secondPath = "/Users/yashsingh/p/multi/packages/app/src/components/messages-timeline.tsx";
    const screen = await render(
      <ChatMarkdown
