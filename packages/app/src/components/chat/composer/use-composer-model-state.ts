...
import type { ComposerThreadDraftState } from "../../../composer-draft-store";
...
import { getComposerProviderState } from "./provider-registry";
...
export function useComposerModelState(input: {
  ...
  return {
    ...
    selectedModelSelection: composerModelSelection.modelSelection,
