  ...
  return (
    ...
    >
      <div
        ref={listRef}
        className={cn(
          "relative max-w-full min-w-[min(var(--composer-menu-width),calc(100vw-32px))] overflow-hidden rounded-lg border border-multi-stroke-secondary bg-[color-mix(in_srgb,var(--glass-chat-bubble-opaque-background)_96%,transparent)] font-multi text-body text-multi-fg-primary shadow-multi-popup backdrop-blur-[18px] motion-reduce:animate-none motion-reduce:transition-none",
        ...
        {props.items.length === 0 ? (
          <div className="ui-menu__empty px-2.5 py-2">
            {props.triggerKind === "skill" ? (
              <CommandGroup>
                <CommandGroupLabel className="ui-menu__section-title px-0! pt-0! pb-[3px] text-caption font-semibold tracking-[0.08em] text-multi-fg-tertiary uppercase">
                  Skills
                </CommandGroupLabel>
