...
/** Distinct glyph for Codex (CLI agent); avoids the unrelated OpenAI wordmark swirl beside a "Codex" label. */
export const CodexIcon: Icon = (props) => (
  <svg
    {...props}
  ...
  >
    <rect x="5" y="5" width="14" height="14" rx="3.5" stroke="currentColor" strokeWidth="1.5" />
    <path
      d="M10 10 7 12.5 10 15"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
...
export const GithubCopilotIcon: Icon = (props) => (
  <svg {...props} preserveAspectRatio="xMidYMid" viewBox="0 0 256 208" fill="currentColor">
