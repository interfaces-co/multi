...
import { ComposerPendingTerminalContextChip } from "./chat/composer-pending-terminal-contexts";
      ...
      <div className="relative">
        <PlainTextPlugin
          contentEditable={
            <ContentEditable
              className={cn(
                "composer-prompt-editor-input block w-full overflow-y-auto whitespace-pre-wrap break-words bg-transparent text-foreground outline-hidden",
                className,
              )}
