...
export function DesktopBridgeDebug() {
  ...
  return (
    <section className="scroll-mt-[4.5rem] font-glass space-y-4" id="debug-desktop-bridge">
      <div className="space-y-1">
        ...
        <p className="text-detail/[1.45] text-muted-foreground">
          Electron exposes <code className="font-glass-mono text-detail">window.desktopBridge</code>
      ...
      {!bridge ? (
        ...
        <div className="flex flex-wrap gap-2">
          <Button
            ...
            variant="outline"
            size="sm"
            className="rounded-glass-control border-glass-border/45"
            onClick={() =>
      ...
      {log ? (
        <pre className="max-h-48 overflow-auto rounded-glass-card border border-glass-border/35 bg-background/30 p-3 font-glass-mono text-detail text-foreground/88">
          {log}
        </pre>
      ) : null}
    </section>
