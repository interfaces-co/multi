...
describe("messages-timeline", () => {
  ...
  it("formats changed file paths from the workspace root", async () => {
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/multi/apps/web/src/session-logic.ts"],
            },
          },
        ]}
    ...
    expect(markup).toContain("multi/apps/web/src/session-logic.ts");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/multi/apps/web/src/session-logic.ts");
  });
});
