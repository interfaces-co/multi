...
import { type DiffPanelMode } from "../components/diff-panel-shell";
...
const DiffPanelContainer = (props: { mode: DiffPanelMode }) => {
  return (
...
const DiffPanelInlineSidebar = (props: {
  ...
  return (
    ...
    >
      ...
      >
        <DiffPanelContainer mode="sidebar" />
        <SidebarRail />
      </Sidebar>
    </SidebarProvider>
  );
