...
export const CLIENT_SETTINGS_STORAGE_KEY = "multi:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "multi:saved-environment-registry:v1";
