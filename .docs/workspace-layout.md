...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@multi/shared/git`, `@multi/shared/DrainableWorker`) — no barrel index.
